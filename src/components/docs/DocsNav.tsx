...
const sections = [
  {
    ...
    links: [
      ...
      { href: "/docs/publisher/bots", label: "Bots", icon: Bot },
    ],
  },
  {
    title: "Advertiser",
  ...
  },
  {
    title: "Developers",
    links: [
      { href: "/docs/developers", label: "Developer API", icon: Code2 },
    ],
  },
];
          ...
          <div className="space-y-1">
            {section.links.map((link) => (
              <Link
                ...
                href={link.href}
                onClick={onNavigate}
                className="flex items-center gap-3 rounded-2xl px-3 py-2.5 text-sm font-bold text-slate-600 transition-colors hover:bg-blue-50 hover:text-blue-600"
              >
                <link.icon size={16} />
                {link.label}
              </Link>
