            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-5 bg-slate-50 rounded-[28px] space-y-1">
                <div className="flex items-center gap-2 text-slate-400 mb-1">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest">Posts/Day</span>
                </div>
                <p className="text-sm font-bold text-slate-900">{channel.posts_per_day} Posts</p>
              </div>
            </div>
