"use client";
/* eslint-disable @typescript-eslint/no-explicit-any -- legacy channel detail payload is not schema-generated */

import React, { useEffect, useState } from "react";
import { motion } from "framer-motion";
import {
  Tv, CheckCircle2, Clock, XCircle, PauseCircle, ChevronLeft,
  Lock, Copy, ShieldCheck, ExternalLink,
} from "lucide-react";
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="space-y-3 p-4 pb-8">
          <OwnerModerationRejection entityType="channel" entityId={channel.id} status={channel.status} />
