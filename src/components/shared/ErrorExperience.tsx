  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#07111f] px-5 py-12 text-white">
      ...
      <section className="relative w-full max-w-xl rounded-[32px] border border-white/10 bg-white/[0.07] p-7 text-center shadow-[0_32px_100px_rgba(0,0,0,.45)] backdrop-blur-2xl sm:p-10">
        <Link href="/" className="mx-auto flex w-fit items-center gap-3" aria-label="AdsGalaxy homepage">
        ...
        <p className="mt-7 text-xs font-black uppercase tracking-[0.28em] text-cyan-300">{t("shared.lost")}</p>
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <Link href="/" className="inline-flex min-h-12 items-center justify-center rounded-2xl bg-gradient-to-r from-blue-500 to-cyan-400 px-6 text-sm font-black text-white shadow-lg shadow-blue-500/20 transition hover:-translate-y-0.5 hover:shadow-blue-500/30">
            {t("shared.returnHome")}
          </Link>
          {onRetry ? (
